...
#define __PYX_HAVE__another_bilateral_implementation
#define __PYX_HAVE_API__another_bilateral_implementation
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
static const char *__pyx_f[] = {
  "another_bilateral_implementation.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
static PyObject *__pyx_memview_get_nn___pyx_t_5numpy_float32_t(const char *itemp);
static int __pyx_memview_set_nn___pyx_t_5numpy_float32_t(const char *itemp, PyObject *obj);
...
/* Module declarations from 'AVX' */

/* Module declarations from 'another_bilateral_implementation' */
...
static float __pyx_f_32another_bilateral_implementation_gaussian(float, float); /*proto*/
static PyObject *__pyx_f_32another_bilateral_implementation_bilateral_filter(float, float, __Pyx_memviewslice, int, int, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "another_bilateral_implementation"
int __pyx_module_is_main_another_bilateral_implementation = 0;

/* Implementation of 'another_bilateral_implementation' */
...
static char __pyx_k_imsize0[] = "imsize0";
static char __pyx_k_imsize1[] = "imsize1";
static char __pyx_k_memview[] = "memview";
static char __pyx_k_sigma_r[] = "sigma_r";
static char __pyx_k_sigma_s[] = "sigma_s";
static char __pyx_k_Ellipsis[] = "Ellipsis";
static char __pyx_k_input_im[] = "input_im";
...
static PyObject *__pyx_n_s_imsize0;
static PyObject *__pyx_n_s_imsize1;
static PyObject *__pyx_n_s_input_im;
...
static PyObject *__pyx_pf_32another_bilateral_implementation_bilateral_filter(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_sigma_s, float __pyx_v_sigma_r, __Pyx_memviewslice __pyx_v_input_im, int __pyx_v_imsize0, int __pyx_v_imsize1, __Pyx_memviewslice __pyx_v_output, int __pyx_v_lw); /* proto */
...
/* "another_bilateral_implementation.pyx":13
 * 
 * 
...
static float __pyx_f_32another_bilateral_implementation_gaussian(float __pyx_v_x2, float __pyx_v_sigma) {
  float __pyx_r;
  double __pyx_t_1;
  float __pyx_t_2;
  int __pyx_lineno = 0;
  ...
  /* "another_bilateral_implementation.pyx":16
 *                 float sigma) nogil:
 *     """get gaussian coefficient with x^2 as input"""
 ...
 */
  __pyx_t_1 = (-.5 * __pyx_v_x2);
  __pyx_t_2 = powf(__pyx_v_sigma, 2.0);
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("another_bilateral_implementation.gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "another_bilateral_implementation.pyx":18
 *     return exp(-.5*x2/sigma**2)
 * 
 * cpdef bilateral_filter(float sigma_s,             # <<<<<<<<<<<<<<
 *                         float sigma_r,
...
static PyObject *__pyx_pw_32another_bilateral_implementation_1bilateral_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_32another_bilateral_implementation_bilateral_filter(float __pyx_v_sigma_s, float __pyx_v_sigma_r, __Pyx_memviewslice __pyx_v_input_im, int __pyx_v_imsize0, int __pyx_v_imsize1, __Pyx_memviewslice __pyx_v_output, int __pyx_v_lw, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_l;
  ...
  __Pyx_memviewslice __pyx_v_local_input = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_windowsize0;
  int __pyx_v_windowsize1;
  float __pyx_v_sumg;
  float __pyx_v_local_output;
  float __pyx_v_I_pixel;
  float __pyx_v_coef;
  ...
  /* "another_bilateral_implementation.pyx":34
 * 
 ...
 * 
 */
  __pyx_t_1 = (__pyx_v_imsize0 + __pyx_v_lw);
  for (__pyx_t_2 = __pyx_v_lw; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    __pyx_v_i = __pyx_t_2;

    /* "another_bilateral_implementation.pyx":35
 *     # to implement with multi process
 *     for i in range(lw, imsize0 + lw):
 *         for j in range(lw, imsize1 + lw):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = (__pyx_v_imsize1 + __pyx_v_lw);
    for (__pyx_t_4 = __pyx_v_lw; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_j = __pyx_t_4;

      /* "another_bilateral_implementation.pyx":38
 * 
 *             # window contining halo
 ...
 */
      __pyx_t_5.data = __pyx_v_input_im.data;
      __pyx_t_5.memview = __pyx_v_input_im.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
      __pyx_t_6 = -1;
      if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_5,
    __pyx_v_input_im.shape[0], __pyx_v_input_im.strides[0], __pyx_v_input_im.suboffsets[0],
    0,
    0,
    &__pyx_t_6,
    (__pyx_v_i - __pyx_v_lw),
    ((__pyx_v_i + __pyx_v_lw) + 1),
    0,
    1,
    1,
    0,
...
if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_5,
    __pyx_v_input_im.shape[1], __pyx_v_input_im.strides[1], __pyx_v_input_im.suboffsets[1],
    1,
    1,
    &__pyx_t_6,
    (__pyx_v_j - __pyx_v_lw),
    ((((__pyx_v_j + 1) + __pyx_v_lw) + 8) - __Pyx_mod_long(((2 * __pyx_v_lw) + 1), 8)),
    0,
    1,
    1,
    0,
...
__PYX_XDEC_MEMVIEW(&__pyx_v_window, 1);
      ...
      /* "another_bilateral_implementation.pyx":39
 *             # window contining halo
 *             window = input_im[i - lw : i + lw + 1, j - lw : j + 1 + lw + 8 - (2 * lw + 1) % 8]
 *             assert np.shape(window) == (2 * lw +1, lw + 1 + lw + 8 - (2 * lw + 1) % 8)             # <<<<<<<<<<<<<<
 *             windowsize0, windowsize1 = np.shape(window)
 ...
 */
      ...
      if (unlikely(!Py_OptimizeFlag)) {
        __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_shape); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_8 = __pyx_memoryview_fromslice(__pyx_v_window, 2, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_float32_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_float32_t, 0);; if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_10 = NULL;
        ...
        if (!__pyx_t_10) {
          __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_t_9, __pyx_t_8); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
          ...
          __pyx_t_8 = 0;
          __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_11, NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_7);
          __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        }
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __pyx_t_9 = __Pyx_PyInt_From_long(((2 * __pyx_v_lw) + 1)); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_9);
        __pyx_t_11 = __Pyx_PyInt_From_long(((((__pyx_v_lw + 1) + __pyx_v_lw) + 8) - __Pyx_mod_long(((2 * __pyx_v_lw) + 1), 8))); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_8 = PyTuple_New(2); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_8);
        ...
        __pyx_t_9 = 0;
        __pyx_t_11 = 0;
        __pyx_t_11 = PyObject_RichCompare(__pyx_t_7, __pyx_t_8, Py_EQ); __Pyx_XGOTREF(__pyx_t_11); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_12 = __Pyx_PyObject_IsTrue(__pyx_t_11); if (unlikely(__pyx_t_12 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      ...
      /* "another_bilateral_implementation.pyx":40
 *             window = input_im[i - lw : i + lw + 1, j - lw : j + 1 + lw + 8 - (2 * lw + 1) % 8]
 *             assert np.shape(window) == (2 * lw +1, lw + 1 + lw + 8 - (2 * lw + 1) % 8)
 *             windowsize0, windowsize1 = np.shape(window)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_shape); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_8 = __pyx_memoryview_fromslice(__pyx_v_window, 2, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_float32_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_float32_t, 0);; if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_9 = NULL;
      ...
      if (!__pyx_t_9) {
        __pyx_t_11 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_8); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_GOTREF(__pyx_t_11);
      } else {
        __pyx_t_10 = PyTuple_New(1+1); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __Pyx_GIVEREF(__pyx_t_9); PyTuple_SET_ITEM(__pyx_t_10, 0, __pyx_t_9); __pyx_t_9 = NULL;
        __Pyx_GIVEREF(__pyx_t_8);
        PyTuple_SET_ITEM(__pyx_t_10, 0+1, __pyx_t_8);
        __pyx_t_8 = 0;
        __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_10, NULL); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_11);
      ...
      if ((likely(PyTuple_CheckExact(__pyx_t_11))) || (PyList_CheckExact(__pyx_t_11))) {
        ...
        __Pyx_GOTREF(__pyx_t_7);
        __pyx_t_10 = PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        #endif
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      } else {
        Py_ssize_t index = -1;
        __pyx_t_8 = PyObject_GetIter(__pyx_t_11); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_13 = Py_TYPE(__pyx_t_8)->tp_iternext;
        index = 0; __pyx_t_7 = __pyx_t_13(__pyx_t_8); if (unlikely(!__pyx_t_7)) goto __pyx_L7_unpacking_failed;
        __Pyx_GOTREF(__pyx_t_7);
        index = 1; __pyx_t_10 = __pyx_t_13(__pyx_t_8); if (unlikely(!__pyx_t_10)) goto __pyx_L7_unpacking_failed;
        __Pyx_GOTREF(__pyx_t_10);
        if (__Pyx_IternextUnpackEndCheck(__pyx_t_13(__pyx_t_8), 2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __pyx_t_13 = NULL;
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      ...
      __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_t_7); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_t_10); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_v_windowsize0 = __pyx_t_6;
      __pyx_v_windowsize1 = __pyx_t_14;

      /* "another_bilateral_implementation.pyx":43
 * 
 *             # initialize normalization term and output term
 *             sumg = 0             # <<<<<<<<<<<<<<
 *             local_output = 0
 ...
 */
      ...
      /* "another_bilateral_implementation.pyx":44
 *             # initialize normalization term and output term
 *             sumg = 0
 *             local_output = 0             # <<<<<<<<<<<<<<
 *             I_pixel = window[lw, lw]
 * 
 */
      __pyx_v_local_output = 0.0;

      /* "another_bilateral_implementation.pyx":45
 *             sumg = 0
 *             local_output = 0
 *             I_pixel = window[lw, lw]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_15 = __pyx_v_lw;
      __pyx_t_16 = __pyx_v_lw;
      __pyx_t_14 = -1;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_window.shape[0];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_window.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_window.shape[1];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_window.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_I_pixel = (*((__pyx_t_5numpy_float32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_window.data + __pyx_t_15 * __pyx_v_window.strides[0]) ) + __pyx_t_16 * __pyx_v_window.strides[1]) )));

      /* "another_bilateral_implementation.pyx":47
 *             I_pixel = window[lw, lw]
 * 
 *             for k in range(windowsize0):             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_14 = __pyx_v_windowsize0;
      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_14; __pyx_t_6+=1) {
        __pyx_v_k = __pyx_t_6;

        /* "another_bilateral_implementation.pyx":48
 * 
 *             for k in range(windowsize0):
 *                 for l in range(0, windowsize1, 8):             # <<<<<<<<<<<<<<
 *                     # take local_input which will become an AVX 8-array
 ...
 */
        __pyx_t_17 = __pyx_v_windowsize1;
        for (__pyx_t_18 = 0; __pyx_t_18 < __pyx_t_17; __pyx_t_18+=8) {
          __pyx_v_l = __pyx_t_18;

          /* "another_bilateral_implementation.pyx":50
 *                 for l in range(0, windowsize1, 8):
 *                     # take local_input which will become an AVX 8-array
 *                     local_input = window[k,l:l+8]             # <<<<<<<<<<<<<<
 ...
 * 
 */
          __pyx_t_19.data = __pyx_v_window.data;
          __pyx_t_19.memview = __pyx_v_window.memview;
          __PYX_INC_MEMVIEW(&__pyx_t_19, 0);
          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_k;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_window.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_window.strides[0];
...
__pyx_t_20 = -1;
          if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_19,
    __pyx_v_window.shape[1], __pyx_v_window.strides[1], __pyx_v_window.suboffsets[1],
    1,
    0,
    &__pyx_t_20,
    __pyx_v_l,
...
__PYX_XDEC_MEMVIEW(&__pyx_v_local_input, 1);
          __pyx_v_local_input = __pyx_t_19;
          __pyx_t_19.memview = NULL;
          __pyx_t_19.data = NULL;

          /* "another_bilateral_implementation.pyx":51
 *                     # take local_input which will become an AVX 8-array
 *                     local_input = window[k,l:l+8]
 *                     assert np.size(local_input) == 8             # <<<<<<<<<<<<<<
 * 
 ...
 */
          #ifndef CYTHON_WITHOUT_ASSERTIONS
          if (unlikely(!Py_OptimizeFlag)) {
            __pyx_t_10 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            __Pyx_GOTREF(__pyx_t_10);
            __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_size); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            __Pyx_GOTREF(__pyx_t_7);
            __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
            __pyx_t_10 = __pyx_memoryview_fromslice(__pyx_v_local_input, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_float32_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_float32_t, 0);; if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            __Pyx_GOTREF(__pyx_t_10);
            __pyx_t_8 = NULL;
            if (CYTHON_COMPILING_IN_CPYTHON && unlikely(PyMethod_Check(__pyx_t_7))) {
            ...
            if (!__pyx_t_8) {
              __pyx_t_11 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_10); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
              __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
              __Pyx_GOTREF(__pyx_t_11);
            } else {
              __pyx_t_9 = PyTuple_New(1+1); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
              __Pyx_GOTREF(__pyx_t_9);
              __Pyx_GIVEREF(__pyx_t_8); PyTuple_SET_ITEM(__pyx_t_9, 0, __pyx_t_8); __pyx_t_8 = NULL;
              __Pyx_GIVEREF(__pyx_t_10);
              PyTuple_SET_ITEM(__pyx_t_9, 0+1, __pyx_t_10);
              __pyx_t_10 = 0;
              __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_9, NULL); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
              __Pyx_GOTREF(__pyx_t_11);
              __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
            }
            __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            __pyx_t_7 = __Pyx_PyInt_EqObjC(__pyx_t_11, __pyx_int_8, 8, 0); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            __Pyx_GOTREF(__pyx_t_7);
            __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
            __pyx_t_12 = __Pyx_PyObject_IsTrue(__pyx_t_7); if (unlikely(__pyx_t_12 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
            __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            if (unlikely(!__pyx_t_12)) {
              PyErr_SetNone(PyExc_AssertionError);
          ...
          /* "another_bilateral_implementation.pyx":53
 *                     assert np.size(local_input) == 8
 * 
 *                     for cur in range(8):             # <<<<<<<<<<<<<<
 ...
 */
          for (__pyx_t_20 = 0; __pyx_t_20 < 8; __pyx_t_20+=1) {
            __pyx_v_cur = __pyx_t_20;

            /* "another_bilateral_implementation.pyx":55
 *                     for cur in range(8):
 *                         # don't consider the pixel if it is outside the window
 *                         if l + cur < 2 * lw + 1:             # <<<<<<<<<<<<<<
 ...
 */
            __pyx_t_12 = (((__pyx_v_l + __pyx_v_cur) < ((2 * __pyx_v_lw) + 1)) != 0);
            if (__pyx_t_12) {

              /* "another_bilateral_implementation.pyx":56
 *                         # don't consider the pixel if it is outside the window
 *                         if l + cur < 2 * lw + 1:
 *                             coef = gaussian((k - lw)**2+(l + cur - lw)**2, sigma_s)             # <<<<<<<<<<<<<<
 *                             coef *= gaussian((<float> local_input[cur] - I_pixel)**2, sigma_r)
 ...
 */
              __pyx_v_coef = __pyx_f_32another_bilateral_implementation_gaussian((__Pyx_pow_long(((long)(__pyx_v_k - __pyx_v_lw)), 2) + __Pyx_pow_long(((long)((__pyx_v_l + __pyx_v_cur) - __pyx_v_lw)), 2)), __pyx_v_sigma_s);

              /* "another_bilateral_implementation.pyx":57
 *                         if l + cur < 2 * lw + 1:
 *                             coef = gaussian((k - lw)**2+(l + cur - lw)**2, sigma_s)
 *                             coef *= gaussian((<float> local_input[cur] - I_pixel)**2, sigma_r)             # <<<<<<<<<<<<<<
 *                             local_output += coef * <float> local_input[cur]
 *                             sumg += coef
 */
              __pyx_t_21 = __pyx_v_cur;
              __pyx_t_22 = -1;
              if (__pyx_t_21 < 0) {
                __pyx_t_21 += __pyx_v_local_input.shape[0];
                if (unlikely(__pyx_t_21 < 0)) __pyx_t_22 = 0;
              } else if (unlikely(__pyx_t_21 >= __pyx_v_local_input.shape[0])) __pyx_t_22 = 0;
              ...
              __pyx_v_coef = (__pyx_v_coef * __pyx_f_32another_bilateral_implementation_gaussian(powf((((float)(*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_local_input.data + __pyx_t_21 * __pyx_v_local_input.strides[0]) )))) - __pyx_v_I_pixel), 2.0), __pyx_v_sigma_r));

              /* "another_bilateral_implementation.pyx":58
 *                             coef = gaussian((k - lw)**2+(l + cur - lw)**2, sigma_s)
 *                             coef *= gaussian((<float> local_input[cur] - I_pixel)**2, sigma_r)
 *                             local_output += coef * <float> local_input[cur]             # <<<<<<<<<<<<<<
 *                             sumg += coef
 * 
 */
              __pyx_t_23 = __pyx_v_cur;
              __pyx_t_22 = -1;
              if (__pyx_t_23 < 0) {
                __pyx_t_23 += __pyx_v_local_input.shape[0];
                if (unlikely(__pyx_t_23 < 0)) __pyx_t_22 = 0;
              } else if (unlikely(__pyx_t_23 >= __pyx_v_local_input.shape[0])) __pyx_t_22 = 0;
              if (unlikely(__pyx_t_22 != -1)) {
                __Pyx_RaiseBufferIndexError(__pyx_t_22);
                {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
              }
              __pyx_v_local_output = (__pyx_v_local_output + (__pyx_v_coef * ((float)(*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_local_input.data + __pyx_t_23 * __pyx_v_local_input.strides[0]) ))))));

              /* "another_bilateral_implementation.pyx":59
 *                             coef *= gaussian((<float> local_input[cur] - I_pixel)**2, sigma_r)
 *                             local_output += coef * <float> local_input[cur]
 *                             sumg += coef             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_v_sumg = (__pyx_v_sumg + __pyx_v_coef);
 ...
 */
      ...
      /* "another_bilateral_implementation.pyx":61
 *                             sumg += coef
 * 
 *             output[i-lw, j-lw] = local_output / sumg             # <<<<<<<<<<<<<<
 */
      if (unlikely(__pyx_v_sumg == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_24 = (__pyx_v_i - __pyx_v_lw);
      __pyx_t_25 = (__pyx_v_j - __pyx_v_lw);
      __pyx_t_14 = -1;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_v_output.shape[0];
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_24 >= __pyx_v_output.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_output.shape[1];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_output.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *((__pyx_t_5numpy_float32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_output.data + __pyx_t_24 * __pyx_v_output.strides[0]) ) + __pyx_t_25 * __pyx_v_output.strides[1]) )) = (__pyx_v_local_output / __pyx_v_sumg);
    }
  }
 ...
 */
  ...
  __Pyx_AddTraceback("another_bilateral_implementation.bilateral_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_window, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_local_input, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_32another_bilateral_implementation_1bilateral_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_32another_bilateral_implementation_1bilateral_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  float __pyx_v_sigma_s;
  float __pyx_v_sigma_r;
  __Pyx_memviewslice __pyx_v_input_im = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_imsize0;
  int __pyx_v_imsize1;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sigma_s,&__pyx_n_s_sigma_r,&__pyx_n_s_input_im,&__pyx_n_s_imsize0,&__pyx_n_s_imsize1,&__pyx_n_s_output,&__pyx_n_s_lw,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sigma_s)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sigma_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilateral_filter", 1, 7, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_input_im)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilateral_filter", 1, 7, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_imsize0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilateral_filter", 1, 7, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_imsize1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilateral_filter", 1, 7, 7, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_output)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilateral_filter", 1, 7, 7, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_lw)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilateral_filter", 1, 7, 7, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bilateral_filter") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_sigma_s = __pyx_PyFloat_AsFloat(values[0]); if (unlikely((__pyx_v_sigma_s == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_sigma_r = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_sigma_r == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_input_im = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_float32_t(values[2]); if (unlikely(!__pyx_v_input_im.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_imsize0 = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_imsize0 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_imsize1 = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_imsize1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_output = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_float32_t(values[5]); if (unlikely(!__pyx_v_output.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_lw = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_lw == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bilateral_filter", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("another_bilateral_implementation.bilateral_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_32another_bilateral_implementation_bilateral_filter(__pyx_self, __pyx_v_sigma_s, __pyx_v_sigma_r, __pyx_v_input_im, __pyx_v_imsize0, __pyx_v_imsize1, __pyx_v_output, __pyx_v_lw);
...
static PyObject *__pyx_pf_32another_bilateral_implementation_bilateral_filter(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_sigma_s, float __pyx_v_sigma_r, __Pyx_memviewslice __pyx_v_input_im, int __pyx_v_imsize0, int __pyx_v_imsize1, __Pyx_memviewslice __pyx_v_output, int __pyx_v_lw) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_input_im.memview)) { __Pyx_RaiseUnboundLocalError("input_im"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_output.memview)) { __Pyx_RaiseUnboundLocalError("output"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_1 = __pyx_f_32another_bilateral_implementation_bilateral_filter(__pyx_v_sigma_s, __pyx_v_sigma_r, __pyx_v_input_im, __pyx_v_imsize0, __pyx_v_imsize1, __pyx_v_output, __pyx_v_lw, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_input_im, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "another_bilateral_implementation.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "another_bilateral_implementation.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "another_bilateral_implementation.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "another_bilateral_implementation._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"bilateral_filter", (PyCFunction)__pyx_pw_32another_bilateral_implementation_1bilateral_filter, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "another_bilateral_implementation",
    0, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_imsize0, __pyx_k_imsize0, sizeof(__pyx_k_imsize0), 0, 0, 1, 1},
  {&__pyx_n_s_imsize1, __pyx_k_imsize1, sizeof(__pyx_k_imsize1), 0, 0, 1, 1},
  {&__pyx_n_s_input_im, __pyx_k_input_im, sizeof(__pyx_k_input_im), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initanother_bilateral_implementation(void); /*proto*/
PyMODINIT_FUNC initanother_bilateral_implementation(void)
#else
PyMODINIT_FUNC PyInit_another_bilateral_implementation(void); /*proto*/
PyMODINIT_FUNC PyInit_another_bilateral_implementation(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_another_bilateral_implementation(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("another_bilateral_implementation", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_another_bilateral_implementation) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "another_bilateral_implementation")) {
      if (unlikely(PyDict_SetItemString(modules, "another_bilateral_implementation", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "another_bilateral_implementation.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 */
  ...
  /* "another_bilateral_implementation.pyx":4
 * cimport numpy as np
 * cimport cython
 * import numpy             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init another_bilateral_implementation", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init another_bilateral_implementation");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
